...
describe("isHttpUrl", () => {
  ...
  // The reason this function exists. Both parse as URLs, so any check that only
  // asks "is this a URL" lets them through — and both are script execution once
  // they reach an `href`.
...
describe("httpUrl", () => {
  ...
  // How a same-origin read proxy is published, and what the dev stack configures.
