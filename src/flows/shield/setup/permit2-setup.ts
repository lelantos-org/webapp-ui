...
import { MAX_UINT256 } from "../permit2-approval";

/// The allowance cap a setup run grants: `type(uint160).max`, the sentinel
/// Permit2 reads as unlimited, and independent of the deposit amount.
///
...
/// the chain. Distinct from `setup/use-setup-status`'s `SetupStepPhase`,
