...
describe("FeeSummary", () => {
  ...
  it("opens the asset picker clear of the rows it sits in", async () => {
    // The Details row animates its height through `overflow: hidden`, which
    // would clip the picker's list to it — and the list is taller than the rows
    // by design. Leaving the subtree is the only way to escape the clip.
