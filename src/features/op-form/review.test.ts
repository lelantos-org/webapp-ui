...
// The review summary must never outlive the thing it summarises: if the form
// changes underneath it, confirming would send figures the user is no longer
// looking at.
...
import { useReview } from "./use-spend-form";

describe("useReview", () => {
  /// The hook on a spend fingerprinted `fp`, opened for review.
