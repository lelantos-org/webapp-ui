...
// Which of the four things the card shows, and that the fields survive all of
// them. The fields are hidden rather than unmounted throughout; a form that
// lost its state on the way back from a review or a failure would re-validate
// the user's entry into something else.
...
describe("ActionForm", () => {
  ...
  it("hides the fields under a review without unmounting them", () => {
    ...
    // The review carries its own confirm; the form's CTA steps aside.
  ...
  it("stays in flight after broadcast until the terminal step, keeping the amount", () => {
    ...
    // The mutation resolves at broadcast and the form clears its amount.
    rerenderWith({
      busy: false,
