...
// Syncs overlap across a chain switch, and the counter is one singleton. The
// owner rule is what keeps a superseded sync from zeroing the live count — the
// only thing that tells a long cold sync from a hang.
