...
import { deriveNskFromSigner, Eip1193Signer, evmAddress } from "@lelantos-org/sdk";
import { useMemo } from "react";
import type { ChainEntry } from "@/config/chains";
import { useStore } from "@/shared/lib/external-store";
import { createLogger } from "@/shared/lib/logger";
import { toastError } from "@/shared/lib/toast";
import { withNonceSync } from "./eip1193/nonce-sync";
import { eip1193Store } from "./eip1193/store";
...
export const eip1193Kind: WalletKindAdapter = {
  ...
  /// Fire-and-forget with a toast, as `useSwitchChain`.
