...
// What the fallback says about the error it caught.
//
// A render crash is not a wallet error, so the card has to stay informative for
// an ordinary `Error` — its message is usually the only clue — while not
// dumping a hex payload or a multi-line trace onto the page.
