...
import { loadSend, loadSendLink, loadShield, loadSwap, loadUnshield } from "@/flows/loaders";
import { cx } from "@/shared/lib/cx";
import { ActionIcon, type ActionIconName } from "./ActionIcon";
import "./Home.css";

/// Route chunks behind each tile, warmed on intent and again at idle. The same
/// loaders `App` lazy-loads the routes with, so a warmed chunk is the route's.
const ACTION_PREFETCH: Record<string, () => Promise<unknown>> = {
  "/shield": loadShield,
  "/send": loadSend,
  "/swap": loadSwap,
  "/unshield": loadUnshield,
  "/send/link": loadSendLink,
};
