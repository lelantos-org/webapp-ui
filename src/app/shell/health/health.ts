...
/// The words on the header's health pill, for a set of probe results.
///
...
/// states the aggregate and, when something is wrong, which thing. Pure, so every
/// state is testable without rendering the pill.
///
