...
// Storage is a cache here, never a source of truth, so every way the browser can
// refuse it — no global, a throwing accessor, a full quota, junk left by an older
// build — has to come back as "absent" rather than as an exception.

import { beforeEach, describe, expect, it, vi } from "vitest";
import { localStore, readJson, sessionStore, writeJson } from "./storage";
...
describe("safe storage", () => {
  ...
  // Safari private mode and sandboxed iframes throw on the property itself.
